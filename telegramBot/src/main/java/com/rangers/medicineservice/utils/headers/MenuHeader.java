...
public class MenuHeader {
    ...
    public static final String CHOOSE_DOCTOR = "Please, choose doctor";
    ...
    public static final String CHOOSE_ITEM_FOR_DELETE =
            "Select a product to remove it from your cart or press CHECKOUT to continue";
    public static final String SELECT_MORE_PRODUCTS = "Do you want to select more products?";
    public static final String CART_IS_EMPTY = "Your cart is empty";
    public static final String DELIVERY_METHOD = "Please, select delivery method";
    public static final String CHOOSE_PRESCRIPTION = "Please, choose a prescription";
    public static final String CHECKOUT_OR_MENU = "Do you want to place an order or return to the main menu?";
}
